    ...
    mounted() {
        ...
        .then(res=>{
            ...
            data.forEach(item=>{
                ...
                this.$store.state.data_time_list.unshift(y+'-'+m+'-'+d);
                ...
                let active_data_arr = [...user_vote_list,...user_pc_list,...this.$store.state.user_active_list]
                let active_data_num = Math.min.apply(null,active_data_arr);
                ...
                let all_user_arr = [...user_new_all_list,...user_active_all_list]
                let all_user_num = Math.min.apply(null,all_user_arr);
                ...
                let comment_arr = [...post_list,...comment_list]
                let comment_num = Math.min.apply(null,comment_arr);

                this.praise_data.xAxis.data = this.$store.state.data_time_list;
                this.praise_data.series[0].data = vote_list;
                let praise_num = Math.min.apply(null,vote_list);

                this.deal_data.xAxis.data = this.$store.state.data_time_list;
                this.deal_data.series[0].data = this.$store.state.transaction_list;
                let deal_num = Math.min.apply(null,this.$store.state.transaction_list);

               setTimeout(()=>{
                    this.active_data.grid = this.grid;
                    ...
                    this.draw_user("active-user-chart",this.active_data,active_data_num);
                    this.draw_user("all-user-chart",this.all_user_data,all_user_num);  
                    this.draw_user("comment-chart",this.comment_data,comment_num);
                    this.draw_user("praise-chart",this.praise_data,praise_num);
                    this.draw_user("deal-chart",this.deal_data,deal_num);
