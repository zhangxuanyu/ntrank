          ...
          <div class="content_middle">
              ...
              <div class="title" v-if="$store.state.lanfalg">
                  <ul>
                      ...
                      <li class="bk_one"></li>
                      <li class="read"  @click="allTrade" :style="allTradeb">
                      ...
                      <li class="tsee"><div class="boxw">链接</div>
                        <!-- <div class="tips">
                          <img src="../../../static/black-block.png" alt="">
...
import data4_13 from '../../assets/data4_13.js'
...
//   beforecreated
  created(){
    axios.post('http://service.tokenrank.net/exchange/exchangeList.json',{},{
