      ...
      <div class="excot" v-show="!$store.state.loadshow" v-if="outarr.total_volume_24h != '11'">
        ...
        <div class="extop">
         ...
         <div class="extop_left">
             ...
             <div class="extrade" v-if="!$store.state.lanfalg">
                    <p>24H Total Volume</p>
        ...
        <!-- 中间货币详情 -->
         <div class="exmdl" v-if="$store.state.lanfalg">
              <div class="mdl_top">
                  服务费说明
              </div>
              <div class="trade">
              ...
              <div class="rate">
                  ...
                  <div class="rtde">
                      <span  v-for="(item,index) in outarr.withdrawal" v-if="index < maxwith"> <span> {{item}} </span><span v-if="index < maxwith - 1 && outarr.withdrawal.length >= maxwith" class="sl">&nbsp; | &nbsp;</span><span v-if="index == maxwith - 1 && showflag">&nbsp;...&nbsp;&nbsp;</span></span><span v-if="!$store.state.lanfalg && showflag  && outarr.withdrawal.length >= maxwith" @click="show" class="ensf">Show more</span><span v-if="$store.state.lanfalg && showflag  && outarr.withdrawal.length >= maxwith" @click="show" class="sf">显示更多</span>
                  </div>
              </div>
          </div>
          <div class="exmdl" v-if="!$store.state.lanfalg">
              ...
              <div class="rate">
                  ...
                  <div class="rtde">
                      <span  v-for="(item,index) in outarr.withdrawal" v-if="index < maxwith"> <span> {{item}} </span><span v-if="index < maxwith - 1" class="sl">&nbsp; | &nbsp;</span><span v-if="index == maxwith - 1 && showflag">&nbsp;...&nbsp;&nbsp;</span></span><span v-if="!$store.state.lanfalg && showflag" @click="show" class="ensf">Show more</span><span v-if="$store.state.lanfalg && showflag" @click="show" class="sf">显示更多</span>
                  </div>
              </div>
          </div>
          <!-- 底部表格 -->
          <div class="bt_table">
              <div class="title" v-if="$store.state.lanfalg">
                  <ul>
                      <li class="first">#</li>
                      <li class="second">交易对</li>
                      <li class="bk_one"></li>
                      <li class="read"  @click="pris" :style="prisb">
                    
                      价格 <img :src="prise" alt="" :style="prisi">
                      ...
                      <li class="bk_two"></li>
                      <li class="marks" @click="hvlo" :style="hvlob">24H成交量 <img :src="hvloe" alt="" :style="hvloi">
                        <!-- <div class="tips mark">
                          <img src="../../../static/black-block.png" alt="">
                          由总供给量乘以价格得出
                      </div> -->
                      ...
                      <li class="bk_thr"></li>
                      <li class="rread" @click="vlop" :style="vlopb"> 交易占比% <img :src="vlope" alt="" :style="vlopi">
              ...
              <div class="title entitle" v-else>
                  ...
                  <ul>
                      <li class="first">#</li>
                      <li class="second">Pair</li>
                      <li class="bk_one"></li>
                      <li class="enread"   @click="pris"  :style="prisb">Price <img :src="prise" alt="" :style="prisi">
                      <!-- <div class="tips price">
                          <img src="../../../static/black-block.png" alt="">
                          Current price
                      ...
                      <li class="bk_two"></li>
                      <li class="enmark">24H Volume <img :src="prise" alt="" :style="prisi">
                        <!-- <div class="tips mark">
                          <img src="../../../static/black-block.png" alt="">
                          Total supply * price
                      </div> -->
                      ...
                      <li class="bk_thr"></li>
                      <li class="enrread">Volume% <img :src="prise" alt="" :style="prisi">
                        <!-- <div class="tips volum">
                          <img src="../../../static/black-block.png" alt="">
...
export default {
  ...
  created(){
      ...
      axios.post('http://service.tokenrank.net/exchange/exchangeDetail.json',{
           "exchange_name": num1
      },{
         ...
         axios.post('http://service.tokenrank.net/exchange/kline.json',{
           "exchange_name": num1,
           "length": "-1"
      },{
            headers: {'Content-Type': "application/x-www-form-urlencoded"}
